/*
  ...
  - Added the required column `consent1` to the `User` table without a default value. This is not possible if the table is not empty.
  - Added the required column `consent2` to the `User` table without a default value. This is not possible if the table is not empty.
